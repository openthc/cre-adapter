...
class WCIA extends \OpenTHC\CRE\Base
{
	...
	static function map_product_type_ct2id($t0, $t1)
	{
		...
		switch ($pt) {
			...
			case 'ENDPRODUCT/HYDROCARBON CONCENTRATE':          return '018NY6XC00PTSF5NTC899SR0JF';
			...
			case 'ENDPRODUCT/CANNABIS MIX INFUSED':             return '018NY6XC00PTGRX4Q9SZBHDA5Z'; // WCIA Product Type mapping disagreement
			case 'ENDPRODUCT/MARIJUANA MIX PACKAGED':           return '018NY6XC00PTKYYGMRSKV4XNH7';
			case 'ENDPRODUCT/CANNABIS MIX PACKAGED':            return '018NY6XC00PTKYYGMRSKV4XNH7'; // WCIA Product Type mapping disagreement
			...
			case 'INTERMEDIATEPRODUCT/CBD':                     return '018NY6XC00PTXB19AQ8N8RW33A';
			...
			case 'INTERMEDIATEPRODUCT/CANNABIS MIX':            return '018NY6XC00PT63ECNBAZH32YC3';
			...
			case 'PROPAGATIONMATERIAL/CLONES':                  return '018NY6XC00PTY9THKSEQ8NFS1J'; // WCIA Product Type mapping disagreement
			default:
				//var_dump($x);
